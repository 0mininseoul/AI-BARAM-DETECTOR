...
**상태:** Phase A 계약 구현·검증 완료. Phase B 사전 점검 구현이 다음 단계
...
- 백엔드 계약: Phase A 구현·검증 완료, live endpoint는 Phase B부터 진행
